package test
{
	...
	public class NativeMatrix3DUnitTest
	{
		private var e : Number = 0.0001;
		...
		{
			pre1.prepend( post1 );
			Assert.assertTrue( "Prepend 1 success", equalMatrices( pre1, result1 ) );
			pre2.prepend( post2 );
			Assert.assertTrue( "Prepend 2 success", equalMatrices( pre2, result2 ) );
		}
		...
		public function transformVectors() : void
		{
			...
			{
				Assert.assertEquals( "Points transform " + i, r[i], t[i] );
			}
		}
